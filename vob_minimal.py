...
def check_pcr_sr_proximity_alert(underlying_price, proximity_pts=20):
...
def send_candle_at_sr_alert(candle, underlying_price, pcr_sr_snapshot, support_levels, resistance_levels, proximity_pts=20):
...
def send_capping_at_sr_alert(sa_result, underlying_price, proximity_pts=20):
